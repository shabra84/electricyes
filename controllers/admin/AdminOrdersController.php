...
class AdminOrdersControllerCore extends AdminController
{
    ...
    public function renderView()
    {
        ...
        //busco si tiene mensaje en el circuito
        ...
        $this->tpl_view_vars = array(
            'mensajeCircuito' => '<a target="_blank" href="https://electricyes.es/content/6-circuito?circ='.$id_user_data.'">VER ESQUEMA</a>',
            'order' => $order,
