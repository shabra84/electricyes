...
{if isset($blocks) && $blocks}
  {foreach from=$blocks item='block' name='block'}
    ...
    <section id="{$hook_class}-block-category-{$smarty.foreach.block.iteration}" class="featured-products clearfix category-block category-block-{$hook_class}{$smarty.foreach.block.iteration}">
