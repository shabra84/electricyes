...
<div id="idTab5" style="margin-top: 2rem;" class="tab-pane fade">
	...
	{if $comments}
			...
			<div class="comment clearfix">
				...
				<div class="istar_content clearfix">
					...
					<div class="itext">
						...
						<p class="text-muted">{$comment.content|escape:'html':'UTF-8'|nl2br}</p>
						<div>
		...
		<p class="align_center ialign_center">
			<a class="btn btn-primary" id="new_comment_tab_btn" class="open-comment-form" href="#new_comment_form">{l s='Write your review' d='productcomments'}</a>
		</p>
        {/if}
	{else}
		{if (!$too_early AND ($logged OR $allow_guests))}
			...
			<div id="new_comment_form">
				<form id="id_new_comment_form" action="#">
					...
					<div class="new_comment_form_content">
						...
						<input id="comment_title" class="iinput form-control" name="title" type="text" value=""/>

						<label for="content">{l s='Your review' d='productcomments'} <sup class="required">*</sup></label>
						<textarea id="content" name="content" class="iinput form-control"></textarea>

						{if $allow_guests == true && !$logged}
							<label>{l s='Your name' d='productcomments'} <sup class="required">*</sup></label>
							<input id="commentCustomerName" class="iinput form-control" name="customer_name" type="text" value=""/>
						{/if}
						...
						<div id="new_comment_form_footer">
							...
							<p class="fr">
								<a class="btn btn-primary" href="javascript:void(0)" id="submitNewMessage" onclick="fnSubmitNewMessage()">{l s='Send' d='productcomments'}</a>
							</p>
							<div style="clear: both;"></div>
						</div>
					</div>
