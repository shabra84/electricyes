...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{$electro_tpl}Desygner_files/style.css">
...
<!--<script src="{$electro_tpl}javascript/c98ded44ba.js"></script>-->
     ...
     -
        ...
        <div class="options">
            ...
            <button data-action="exit" class="desygner-btn light">
                <span><a href="{$urls.base_url}" >Salir</a></span>
            </button>
        </div>
                            ...
                            <div class="antiscroll-wrap">
                                <div class="antiscroll-inner" style="width: 315px; height: 407px;">
                                    ...
                                    <table width="100%" align="center" id="table_materials" style="margin-left: 50px;">
                                            {$listado_esquemas_tipo nofilter}
