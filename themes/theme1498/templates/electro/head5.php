<script type="text/javascript">
	...
	<script type="text/javascript" src="javascript/examples/editors/js/app.js"></script>
	<script type="text/javascript">
		...
		function vertical()
		{
			...
			var new_img="piezas/vert/"+src+"_x1.png";
			
			if (src.indexOf('_x1')!=-1) 
			{
				new_img =  src.replace('_x1', "");
				new_img += ".png";
				new_img = 'piezas/vert/'+new_img;
			}
		...
		function horizontal()
		{
			...
			var new_img="piezas/vert/"+src+"_x2.png";
		...
		function main(container, outline, toolbar, sidebar, status)
		{
				...
				*/
				...
				(function()
				{
					...
					$( document ).ready(function() {
							...
							//saco el width que lleva el footer
							//var width_footer=window.screen.width - 755;
							//$(".tool-size").width( width_footer);
							...
							//borro todo
							 ...
							 <?php 
						     $x=file_get_contents('http://www.melopo.com/electro/xml/xml3.xml');
							 $x= preg_replace( "/\r|\n/", "", $x );
							 ?>
							 var xml = '<?php echo $x ?>';
							...
							$( "#s_load2" ).click(function() {
							 ...
							 <?php 
							 $x=file_get_contents('http://www.melopo.com/electro/xml/xml1.xml');
							 $x= preg_replace( "/\r|\n/", "", $x );
							 ?>
							 var xml = '<?php echo $x ?>';
		                     var doc = mxUtils.parseXml(xml);
							...
							$( "#s_load3" ).click(function() {
							 ...
							 graph.removeCells(graph.getChildVertices(graph.getDefaultParent()));					
							<?php 
							 $x=file_get_contents('http://www.melopo.com/electro/xml/xml2.xml');
							 $x= preg_replace( "/\r|\n/", "", $x );
							 ?>
							 var xml = '<?php echo $x ?>';
							...
							$( "#table-panel" ).click(function() {
								...
								if(document.getElementById("full_footer_form") !== null)
								{
									...
									<?php 
									$x=file_get_contents('http://www.melopo.com/electro/xml/footer_form.php');
									$x= preg_replace( "/\r|\n/", "", $x );
									?>
									content.innerHTML = '<?php echo $x;?>';
									console.log("paso2");
								}
			...
			{						console.log($("#fo_"+c).val());
							...
							$( "#s_rotate" ).click(function() {
								...
								//var valx = cell.value;
								//var new_img='<img id="x-1-2" src="http://www.melopo.com/electro/piezas/piez03.png" width="132.57142857142858" height="67.14868804664724">';
								//$("#x-1-2").css({'transform': 'rotate(180deg)'});
								//$("#x-1-2").css("transform", "rotate(180deg)");
								$("#x-1-2").rotate(180);
								//graph.model.setValue(cell, new_img);
								//console.log(valx);
				...
				*/
				...
				graph.dblClick = function(evt, cell)
				{
					...
					if (this.isEnabled() &&
						...
						else
						{
							...
							//content.innerHTML = this.convertValueToString(cell);
							<?php 
							$x=file_get_contents('http://www.melopo.com/electro/xml/propiedades.php');
							$x= preg_replace( "/\r|\n/", "", $x );
							?>
				...
				addSidebarIcon(graph, sidebar,
					...
					'http://www.melopo.com/electro/piezas/piez01.png', '1', 1) ;
		...
		//canpalte
		function addSidebarIcon(graph, sidebar, label, image, id=null, num, tam_type=1, pieza_name='test')
		{
			...
			var funct = function(graph, evt, cell, x, y)
			{
				...
				try
				{
					...
					/*
					var v2 = graph.insertVertex(v1, '666', 'V1', 0, 0.5, 20, 20, 'fontSize=12;strokeColor=none;fillColor=#FFFFFF;resizable=0;autosize=1;');
					v2.geometry.offset = new mxPoint(20, 17);
			...
			td.appendChild(img);
			$('#I-'+num).append("<div class='nombre_pieza'>Nombre de la Pieza</div>");
