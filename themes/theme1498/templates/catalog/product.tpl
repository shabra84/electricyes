        ...
        <div class="col-md-5 col-lg-6">
          {block name='page_header_container'}
            {block name='page_header'}
              <h1 class="h2" itemprop="name">{block name='page_title'}{$product.name}{/block}</h1>
            {/block}
          {/block}
          ...
          <div class="product-information">
            {block name='product_description_short'}
              <div id="product-description-short-{$product.id}" class="text-muted hidden-xs-down" itemprop="description">{$product.description_short nofilter}</div>
            {/block}
        ...
        <div class="tab-content" id="tab-content">
          <div class="tab-pane fade in{if $product.description} active{/if}" id="description" role="tabpanel">
            {block name='product_description'}
              <div class="product-description text-muted">{$product.description nofilter}</div>
            {/block}
          </div>
    ...
    {block name='product_accessories'}
      {if $accessories}
        <section class="featured-products product-accessories clearfix">
          <h1 class="h5 products-section-title">{l s='You might also like' d='Shop.Theme.Catalog'}</h1>
          <div class="products">
