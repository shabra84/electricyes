...
{if isset($daydeal_products_extra["data_end"]) && $daydeal_products_extra["data_end"]}
  ...
  <div class="block products_block daydeal-box">
    <h3>{l s='Time left to buy' mod='tmdaydeal'}</h3>
  ...
  {if isset($smarty.post.action)}
    <script type="text/javascript">
      var tmdd_msg_days = "{l s='days' mod='tmdaydeal' js=1}",
          tmdd_msg_hr = "{l s='hr' mod='tmdaydeal' js=1}",
          tmdd_msg_min = "{l s='min' mod='tmdaydeal' js=1}",
          tmdd_msg_sec = "{l s='sec' mod='tmdaydeal' js=1}";
