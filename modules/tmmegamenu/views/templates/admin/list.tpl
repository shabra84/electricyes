...
<div id="tmmegamenu-configurations-buttons" class="panel clearfix">
  ...
  <button type="button" class="btn btn-sm btn-primary pull-right" id="get-settings"><i class="process-icon-cogs"></i> {l s='Edit settings' mod='tmmegamenu'}</button>
      ...
      <table class="table tablist table-striped">
        ...
        {foreach from=$tabs item=tab name='tab'}
          <tr id="item_{$tab.id_item|escape:'htmlall':'UTF-8'}">
            ...
            <td>
              <a class="list-action-enable{if $tab.active} action-enabled{else} action-disabled{/if}" href="{$url_enable|escape:'html':'UTF-8'}&updateItemStatus&id_item={$tab.id_item|escape:'htmlall':'UTF-8'}&itemstatus={$tab.active|escape:'htmlall':'UTF-8'}{if isset($currentHook) && $currentHook}&hookName={$currentHook|escape:'html':'UTF-8'}{/if}" title="{if $tab.active}{l s='Enabled' mod='tmmegamenu'}{else}{l s='Disabled' mod='tmmegamenu'}{/if}">
            ...
            <td>
              <div class="btn-group-action">
                <div class="btn-group pull-right">
                  <a class="edit btn btn-default" title="{l s='Edit' mod='tmmegamenu'}" href="{$url_enable|escape:'html':'UTF-8'}&editItem&id_item={$tab.id_item|escape:'htmlall':'UTF-8'}{if isset($currentHook) && $currentHook}&hookName={$currentHook|escape:'html':'UTF-8'}{/if}"><i class="icon-pencil"></i> {l s='Edit' mod='tmmegamenu'}
                  </a>
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a class="delete" title="{l s='Delete' mod='tmmegamenu'}" href="{$url_enable|escape:'html':'UTF-8'}&deleteItem&id_item={$tab.id_item|escape:'htmlall':'UTF-8'}{if isset($currentHook) && $currentHook}&hookName={$currentHook|escape:'html':'UTF-8'}{/if}"><i class="icon-trash"></i> {l s='Delete' mod='tmmegamenu'}
                      </a></li>
                  </ul>
                </div>
              </div>
        ...
        {foreach from=$html_items item=item name='html'}
          <tr {if $smarty.foreach.html.iteration is div by 2}class="odd"{/if}>
            ...
            <td>
              <div class="btn-group-action">
                <div class="btn-group pull-right">
                  <a class="edit btn btn-default" title="{l s='Edit' mod='tmmegamenu'}" href="{$url_enable|escape:'html':'UTF-8'}&editHtml&id_item={$item.id_item|escape:'htmlall':'UTF-8'}{if isset($currentHook) && $currentHook}&hookName={$currentHook|escape:'html':'UTF-8'}{/if}"><i class="icon-pencil"></i> {l s='Edit' mod='tmmegamenu'}
                  </a>
                  <button class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                    <i class="icon-caret-down"></i>&nbsp;
                  </button>
                  <ul class="dropdown-menu">
                    <li>
                      <a class="delete" title="{l s='Delete' mod='tmmegamenu'}" href="{$url_enable|escape:'html':'UTF-8'}&deleteHtml&id_item={$item.id_item|escape:'htmlall':'UTF-8'}{if isset($currentHook) && $currentHook}&hookName={$currentHook|escape:'html':'UTF-8'}{/if}"><i class="icon-trash"></i> {l s='Delete' mod='tmmegamenu'}
                      </a></li>
                  </ul>
                </div>
              </div>
        ...
        {foreach from=$links item=item name='link'}
          <tr {if $smarty.foreach.link.iteration is div by 2}class="odd"{/if}>
            ...
            <td>
              <div class="btn-group-action">
                <div class="btn-group pull-right">
                  <a class="edit btn btn-default" title="{l s='Edit' mod='tmmegamenu'}" href="{$url_enable|escape:'html':'UTF-8'}&editLink&id_item={$item.id_item|escape:'htmlall':'UTF-8'}{if isset($currentHook) && $currentHook}&hookName={$currentHook|escape:'html':'UTF-8'}{/if}"><i class="icon-pencil"></i> {l s='Edit' mod='tmmegamenu'}
                  </a>
                  <button class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                    <i class="icon-caret-down"></i>&nbsp;
                  </button>
                  <ul class="dropdown-menu">
                    <li>
                      <a class="delete" title="{l s='Delete' mod='tmmegamenu'}" href="{$url_enable|escape:'html':'UTF-8'}&deleteLink&id_item={$item.id_item|escape:'htmlall':'UTF-8'}{if isset($currentHook) && $currentHook}&hookName={$currentHook|escape:'html':'UTF-8'}{/if}"><i class="icon-trash"></i> {l s='Delete' mod='tmmegamenu'}
                      </a></li>
                  </ul>
                </div>
              </div>
        ...
        {foreach from=$banners item=item name='link'}
          <tr {if $smarty.foreach.link.iteration is div by 2}class="odd"{/if}>
            ...
            <td>
              <div class="btn-group-action">
                <div class="btn-group pull-right">
                  <a class="edit btn btn-default" title="{l s='Edit' mod='tmmegamenu'}" href="{$url_enable|escape:'html':'UTF-8'}&editBanner&id_item={$item.id_item|escape:'htmlall':'UTF-8'}{if isset($currentHook) && $currentHook}&hookName={$currentHook|escape:'html':'UTF-8'}{/if}"><i class="icon-pencil"></i> {l s='Edit' mod='tmmegamenu'}
                  </a>
                  <button class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                    <i class="icon-caret-down"></i>&nbsp;
                  </button>
                  <ul class="dropdown-menu">
                    <li>
                      <a class="delete" title="{l s='Delete' mod='tmmegamenu'}" href="{$url_enable|escape:'html':'UTF-8'}&deleteBanner&id_item={$item.id_item|escape:'htmlall':'UTF-8'}{if isset($currentHook) && $currentHook}&hookName={$currentHook|escape:'html':'UTF-8'}{/if}"><i class="icon-trash"></i> {l s='Delete' mod='tmmegamenu'}
                      </a></li>
                  </ul>
                </div>
              </div>
        ...
        {foreach from=$videos item=item name='link'}
          <tr {if $smarty.foreach.link.iteration is div by 2}class="odd"{/if}>
            ...
            <td>
              <div class="btn-group-action">
                <div class="btn-group pull-right">
                  <a class="edit btn btn-default" title="{l s='Edit' mod='tmmegamenu'}" href="{$url_enable|escape:'html':'UTF-8'}&editVideo&id_item={$item.id_item|escape:'htmlall':'UTF-8'}{if isset($currentHook) && $currentHook}&hookName={$currentHook|escape:'html':'UTF-8'}{/if}"><i class="icon-pencil"></i> {l s='Edit' mod='tmmegamenu'}
                  </a>
                  <button class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                    <i class="icon-caret-down"></i>&nbsp;
                  </button>
                  <ul class="dropdown-menu">
                    <li>
                      <a class="delete" title="{l s='Delete' mod='tmmegamenu'}" href="{$url_enable|escape:'html':'UTF-8'}&deleteVideo&id_item={$item.id_item|escape:'htmlall':'UTF-8'}{if isset($currentHook) && $currentHook}&hookName={$currentHook|escape:'html':'UTF-8'}{/if}"><i class="icon-trash"></i> {l s='Delete' mod='tmmegamenu'}
                      </a></li>
                  </ul>
                </div>
              </div>
        ...
        {foreach from=$maps item=item name='link'}
          <tr {if $smarty.foreach.link.iteration is div by 2}class="odd"{/if}>
            ...
            <td>
              <div class="btn-group-action">
                <div class="btn-group pull-right">
                  <a class="edit btn btn-default" title="{l s='Edit' mod='tmmegamenu'}" href="{$url_enable|escape:'html':'UTF-8'}&editMap&id_item={$item.id_item|escape:'htmlall':'UTF-8'}{if isset($currentHook) && $currentHook}&hookName={$currentHook|escape:'html':'UTF-8'}{/if}"><i class="icon-pencil"></i> {l s='Edit' mod='tmmegamenu'}
                  </a>
                  <button class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                    <i class="icon-caret-down"></i>&nbsp;
                  </button>
                  <ul class="dropdown-menu">
                    <li>
                      <a class="delete" title="{l s='Delete' mod='tmmegamenu'}" href="{$url_enable|escape:'html':'UTF-8'}&deleteMap&id_item={$item.id_item|escape:'htmlall':'UTF-8'}{if isset($currentHook) && $currentHook}&hookName={$currentHook|escape:'html':'UTF-8'}{/if}"><i class="icon-trash"></i> {l s='Delete' mod='tmmegamenu'}
                      </a></li>
                  </ul>
                </div>
              </div>
      ...
      <div class="modal-body">
        <div class="form-wrapper">
          <form id="tmmegamenu-style" class="form-horizontal" action="" method="post">
            ...
            <fieldset>
              <h4>{l s='Top level element link' mod='tmmegamenu'}<span>{l s='(hover & active)' mod='tmmegamenu'}</span>
              </h4>
              <div class="fieldset-content-wrapper closed">
                <div class="form-group">
                  <label class="control-label col-lg-2">{l s='Color' mod='tmmegamenu'}</label>
            ...
            <fieldset>
              <h4>{l s='Next level element link' mod='tmmegamenu'}<span>{l s='(hover & active)' mod='tmmegamenu'}</span>
              </h4>
              <div class="fieldset-content-wrapper closed">
                <div class="form-group">
                  <label class="control-label col-lg-2">{l s='Color' mod='tmmegamenu'}</label>
