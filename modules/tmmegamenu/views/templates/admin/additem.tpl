    ...
    <div class="form-wrapper">
      <div class="form-group">
        ...
        {foreach from=$languages item=language}
          ...
          <div class="translatable-field lang-{$language.id_lang|escape:'htmlall':'UTF-8'}">
            <div class="col-lg-2">
              <input type="text" id="name_{$language.id_lang|escape:'htmlall':'UTF-8'}" class="tagify CurrentText" name="name_{$language.id_lang|escape:'htmlall':'UTF-8'}" value="{if isset($item) && $item && isset($item.$title_text)}{$item.$title_text|escape:'htmlall':'UTF-8'}{/if}"/>
            </div>
            <div class="col-lg-1">
      ...
      <div class="form-group tmmegamenu_url_text">
        ...
        <div class="tmmegamenu-fields-url" style="display:none;">
          {foreach from=$languages item=language}
            ...
            <div class="translatable-field lang-{$language.id_lang|escape:'htmlall':'UTF-8'}">
              <div class="col-lg-2">
                <input type="text" id="url_{$language.id_lang|escape:'htmlall':'UTF-8'}" class="tagify CurrentText" name="tab_url_{$language.id_lang|escape:'htmlall':'UTF-8'}" placeholder="{l s='Custom Url' mod='tmmegamenu'}" value="{if isset($item) && $item && $item.is_custom_url && isset($item.$url_text)}{$item.$url_text|escape:'htmlall':'UTF-8'}{/if}"/>
              </div>
              <div class="col-lg-1">
                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                  {$language.iso_code|escape:'htmlall':'UTF-8'}
      ...
      <div class="form-group">
        ...
        {foreach from=$languages item=language}
          ...
          <div class="translatable-field lang-{$language.id_lang|escape:'htmlall':'UTF-8'}">
            <div class="col-lg-2">
              <input type="text" id="badge_{$language.id_lang|escape:'htmlall':'UTF-8'}" class="tagify CurrentText" name="badge_{$language.id_lang|escape:'htmlall':'UTF-8'}" value="{if isset($item) && $item && isset($item.$badge_text)}{$item.$badge_text|escape:'htmlall':'UTF-8'}{/if}"/>
            </div>
            <div class="col-lg-1">
              <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                {$language.iso_code|escape:'htmlall':'UTF-8'}
