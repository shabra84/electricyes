...
require_once(dirname(__FILE__).'/../../src/entities/TMHeaderAccountEntity.php');

class TmHeaderAccountGoogleRegistrationModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        if (Customer::customerExists($email)) {
            ...
            if ($google_id) {
                if ($google_id == $user_id) {
                    Tools::redirect($this->context->link->getModuleLink('tmheaderaccount', 'googlelogin', array(), false, $this->context->language->id));
                } else {
        ...
        $this->setTemplate('module:tmheaderaccount/views/templates/front/googleregistration.tpl');
    }
}
