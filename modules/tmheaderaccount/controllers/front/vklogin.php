...
require_once(dirname(__FILE__).'/../../vk/VK.php');
require_once(dirname(__FILE__).'/../../vk/VKException.php');
...
class TmHeaderAccountVKLoginModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        if (isset($access_token) && $access_token) {
            ...
            $this->setTemplate('module:tmheaderaccount/views/templates/front/vklogin.tpl');
        } else {
            Tools::redirect($vk->getAuthorizeURL($vk_settings, $vk_redirect_url));
        }
    }
