...
include_once _PS_MODULE_DIR_ . 'tmheaderaccount/src/entities/TMHeaderAccountEntity.php';
include_once _PS_MODULE_DIR_ . 'tmheaderaccount/src/repositories/TMHeaderAccountRepository.php';

class Tmheaderaccount extends Module implements WidgetInterface
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new TMHeaderAccountRepository(
            Db::getInstance(),
            $this->context->shop,
    ...
    public function hookDisplayHeader()
    {
        ...
        $this->context->controller->registerJavascript('module-tmheaderaccount', 'modules/' .$this->name. '/views/js/tmheaderaccount.js');
        $this->context->controller->registerStylesheet('module-tmheaderaccount', 'modules/' .$this->name. '/views/css/tmheaderaccount.css');
    }
    ...
    {
        $path = __DIR__ . '/views/templates/hook';
    ...
    public function renderWidget($hookName, array $configuration)
    {
        ...
        return $this->display(__FILE__, $this->getHookTemplatesPath($hookName, 'tmheaderaccount.tpl'));
    }
