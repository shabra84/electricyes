...
<div class="row {if isset($productLast) and $productLast && (not isset($ignoreProductLast) or !$ignoreProductLast)}last_item{elseif isset($productFirst) and $productFirst}first_item{/if} {if isset($customizedDatas.$productId.$productAttributeId) AND $quantityDisplayed == 0}alternate_item{/if} cart_item address_{$product.id_address_delivery|intval}"
    ...
    <div class="col-md-9 col-lg-{if $CONFIGS.OPC_SHOW_UNIT_PRICE}3{else}5{/if} col-xs-9 col-9 cart_description">
            ...
            <span>
                ...
                {foreach $product.customizations as $customization}
                    {foreach $customization.fields as $key => $field}
                        {if $key > 0}, {/if}{$field.label}: {$field.text}
                    {/foreach}
                {/foreach}
            </span>
        {/if}
    ...
    <div class="col-lg-4 col-md-9 col-xs-9 col-9 text-md-center">
        <div class="input-group bootstrap-touchspin">
            ...
            {else}
                ...
                <input
                    ...
                    data-down-url="{$product.down_quantity_url}{if isset($mega)}&id_megacart={$mega.id_megacart}{/if}"
                    data-up-url="{$product.up_quantity_url}{if isset($mega)}&id_megacart={$mega.id_megacart}{/if}"
                    data-update-url="{$product.update_quantity_url}{if isset($mega)}&id_megacart={$mega.id_megacart}{/if}"
        ...
        <a
            ...
            rel                         = "nofollow"
            href                        = "{$product.remove_from_cart_url}{if isset($mega)}&id_megacart={$mega.id_megacart}{/if}"
