...
//			$default_value = Tools::substr($default_value, 0, $field_class->size);
    ...
    public function getMediaFront()
    {
        ...
        if ($this->config_vars['OPC_REDIRECT_DIRECTLY_TO_OPC'] || !Tools::getIsset('rc')) {
...
//					}
    ...
    public function getTemplateVarsOPC($only_register, $show_authentication)
    {
        ...
        $position_steps = array(
            0 => array(
                'classes' => ($only_register ? '' : 'col-lg-4 col-md-5 col-sm-12').' col-xs-12 col-12',
                'rows' => array(
                    0 => array(
                        'name_step' => 'customer',
            ...
            1 => array(
                'classes' => 'col-lg-8 col-md-7 col-sm-12 col-xs-12 col-12',
                'rows' => array(
                    0 => array(
                        'name_step' => 'carrier',
                        'classes' => 'col-xs-12 col-12 col-md-12 col-lg-6'
                    ),
                    1 => array(
                        'name_step' => 'payment',
                        'classes' => 'col-xs-12 col-12 col-md-12 col-lg-6'
