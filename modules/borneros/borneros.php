...
class Borneros extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Borneros');
        $this->description = $this->l('Configuracion de los Borneros');
    ...
    {
        //Configuration::updateValue('BORNEROS_LIVE_MODE', false);
    ...
    {
        //Configuration::deleteByName('BORNEROS_LIVE_MODE');
    ...
    public function getContent()
    {
         ...
         */
        if (((bool)Tools::isSubmit('submitBornerosModule')) == true) {
            $this->postProcess();
        }
        ...
        if($_POST['sub']!="")
        {
            ...
            if($_POST['sub']=="1")
            $insert = "update `" . _DB_PREFIX_ . "borneros` set texto = '$data' ";
            if($_POST['sub']=="2")
            $insert = "update `" . _DB_PREFIX_ . "borneros` set texto2 = '$data' ";
            if($_POST['sub']=="3")
            $insert = "update `" . _DB_PREFIX_ . "borneros` set texto3 = '$data' ";
    ...
    protected function renderForm()
    {
        ...
        $helper->submit_action = 'submitBornerosModule';
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'name' => 'BORNEROS_ACCOUNT_EMAIL',
                        'label' => $this->l('Email'),
                    ),
                    array(
                        'type' => 'password',
                        'name' => 'BORNEROS_ACCOUNT_PASSWORD',
    ...
    {
        return array(
            'BORNEROS_LIVE_MODE' => Configuration::get('BORNEROS_LIVE_MODE', true),
            'BORNEROS_ACCOUNT_EMAIL' => Configuration::get('BORNEROS_ACCOUNT_EMAIL', 'contact@prestashop.com'),
            'BORNEROS_ACCOUNT_PASSWORD' => Configuration::get('BORNEROS_ACCOUNT_PASSWORD', null),
        );
    }
