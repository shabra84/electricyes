...
class Tmproductzoomer extends Module
{
    ...
    public function install()
    {
        ...
        return parent::install() &&
            ...
            $this->registerHook('hookDisplayFooterProduct2') &&
    ...
    protected function validateSettings()
    {
        ...
        if (!Validate::isInt(Tools::getValue('TMPRODUCTZOOMER_ZOOM_WINDOW_WIDTH'))
            || Tools::getValue('TMPRODUCTZOOMER_ZOOM_WINDOW_WIDTH') < 0) {
            $errors[] = $this->displayError($this->l('"Zoom Window Width" value error.
            Only integer numbers are allowed.'));
        }

        if (!Validate::isInt(Tools::getValue('TMPRODUCTZOOMER_ZOOM_WINDOW_HEIGHT'))
        ...
        if (!Validate::isInt(Tools::getValue('TMPRODUCTZOOMER_ZOOM_WINDOW_OFFSET_X'))
        ...
        if (!Validate::isInt(Tools::getValue('TMPRODUCTZOOMER_ZOOM_WINDOW_OFFSET_Y'))
        ...
        if (!Validate::isInt(Tools::getValue('TMPRODUCTZOOMER_ZOOM_WINDOW_POSITION'))
        ...
        if (!Validate::isColor(Tools::getValue('TMPRODUCTZOOMER_ZOOM_WINDOW_BG_COLOUR'))) {
            $errors[] = $this->l('"Zoom Window Bg Color" format error.');
        }

        if (!Validate::isInt(Tools::getValue('TMPRODUCTZOOMER_ZOOM_WINDOW_FADE_IN'))
        ...
        if (!Validate::isInt(Tools::getValue('TMPRODUCTZOOMER_ZOOM_WINDOW_FADE_OUT'))
        ...
        if (!Validate::isInt(Tools::getValue('TMPRODUCTZOOMER_ZOOM_BORDER_SIZE'))
            || Tools::getValue('TMPRODUCTZOOMER_ZOOM_BORDER_SIZE') < 0) {
            $errors[] = $this->l('"Border Size" value error. Only integer numbers are allowed.');
        }

        if (!Validate::isColor(Tools::getValue('TMPRODUCTZOOMER_ZOOM_BORDER_COLOR'))) {
            $errors[] = $this->l('"Border Color" format error.');
        }

        if (!Validate::isColor(Tools::getValue('TMPRODUCTZOOMER_ZOOM_LENS_COLOUR'))) {
            $errors[] = $this->l('"Lens Color" format error.');
        }

        if (!Validate::isFloat(Tools::getValue('TMPRODUCTZOOMER_ZOOM_LENS_OPACITY'))
            || Tools::getValue('TMPRODUCTZOOMER_ZOOM_BORDER_SIZE') < 0) {
            $errors[] = $this->l('"Lens Opacity" value error. Only float numbers are allowed.');
        }

        if (!Validate::isInt(Tools::getValue('TMPRODUCTZOOMER_ZOOM_LENS_SIZE'))
        ...
        if (!Validate::isColor(Tools::getValue('TMPRODUCTZOOMER_ZOOM_LENS_BORDER_COLOR'))) {
            $errors[] = $this->l('"Lens Border Color" format error.');
        }

        if (!Validate::isColor(Tools::getValue('TMPRODUCTZOOMER_ZOOM_TINT_COLOUR'))) {
            $errors[] = $this->l('"Tint Color" format error.');
        }

        if (!Validate::isFloat(Tools::getValue('TMPRODUCTZOOMER_ZOOM_TINT_OPACITY'))
        ...
        if (!Validate::isInt(Tools::getValue('TMPRODUCTZOOMER_ZOOM_WINDOW_TINT_FADE_IN'))
        ...
        if (!Validate::isInt(Tools::getValue('TMPRODUCTZOOMER_ZOOM_WINDOW_TINT_FADE_OUT'))
    ...
    public function hookDisplayHeader()
    {
        if (!Configuration::get('PS_DISPLAY_JQZOOM') && Configuration::get('TMPRODUCTZOOMER_LIVE_MODE') &&
            ...
            $this->context->controller->registerJavascript('module-tmproductzoomer', 'modules/' .$this->name. '/views/js/tmproductzoomer.js');
            $this->context->controller->registerJavascript('module-tmproductzoomer-ep', 'modules/'. $this->name. '/views/js/jquery.ez-plus.js');
            $this->context->controller->registerStylesheet('module-tmproductzoomer', 'modules/' .$this->name. '/views/css/tmproductzoomer.css');
