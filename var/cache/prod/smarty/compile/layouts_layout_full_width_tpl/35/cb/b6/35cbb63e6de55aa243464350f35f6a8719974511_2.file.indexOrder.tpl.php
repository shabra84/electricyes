<?php
/* Smarty version 3.1.32, created on 2019-11-26 02:33:11
  from '/home/nuevaelectricyes/public_html/themes/theme1498/templates/electro/indexOrder.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5ddc80d7c9bbb8_11790820',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '35cbb63e6de55aa243464350f35f6a8719974511' => 
    array (
      0 => '/home/nuevaelectricyes/public_html/themes/theme1498/templates/electro/indexOrder.tpl',
      1 => 1569824279,
      2 => 'file',
    ),
  ),
  ...
  array (
    'file:./head.tpl' => 1,
    'file:./contenido5.tpl' => 1,
  ),
),false)) {
function content_5ddc80d7c9bbb8_11790820 (Smarty_Internal_Template $_smarty_tpl) {
?><html itemscope="" itemtype="http://schema.org/Article" class="lato fa-events-icons-failed">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <style type="text/css"></style>

    <link rel="stylesheet" type="text/css" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['electro_tpl']->value, ENT_QUOTES, 'UTF-8');?>
Desygner_files/style.css">
...
>
<?php echo '<script'; ?>
 src="https://use.fontawesome.com/c98ded44ba.js"><?php echo '</script'; ?>
>
...
<!--<?php echo '<script'; ?>
 src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['electro_tpl']->value, ENT_QUOTES, 'UTF-8');?>
javascript/c98ded44ba.js"><?php echo '</script'; ?>
>-->
...
?>
    ...
    filter: progid:DXImageTransform.Microsoft.BasicImage(rotation=2);
        ...
        .attributoList{ width: 100%; text-align: center;
            border-color: #8C8C8C;
            border-style: solid;
            border-width: 1px;
            padding: 1px;
        ...
        .attributoList-left{ display: inline-block; text-align: right; width: 150px; }
        .attributoList-right{ display: inline-block; text-align: left; width: 140px;}
        ...
        .saveCuadroAtributo input{
            font-size: 15px !important;
            padding: 4px !important;
            color: #000000;
        }
        .saveCuadroAtributoMsg{
            font-size: 15px !important;
            padding: 4px !important;
            color: #000000;   
            text-align: center;
    ...
    <header>
        <div class="menus">
            ...
            <!--
                ...
                -->
                <!--
                <li class="desygner-dropdown-menu pointer" id="s_validate">
                    <button data-action="validar" class="disabled">
                        <span >FINALIZAR </span>
                    </button>
                </li>
                -->
     ...
     -
        ...
        <div class="options">
            ...
            <button data-action="print" class="desygner-btn light">
             ...
             -->
            <!--<button class="desygner-btn light" onclick="send_to_cart();" >-->
            <!--
            <button class="desygner-btn light" id="s_validate" >
                <span>FINALIZAR</span>
            </button>

            <button class="desygner-btn light" onclick="rehacer();" >
                <span>Rehacer Diseño</span>
            </button>

            <button data-action="exit" class="desygner-btn light" onclick="guardar_esquema();">
                <span>Guardar</span>
            </button>
            <button data-action="exit" class="desygner-btn light">
                <span><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['urls']->value['base_url'], ENT_QUOTES, 'UTF-8');?>
" >Salir</a></span>
            </button>
            -->
        </div>
        ...
        <panel id="tool-panel">
            <div class="tool-menu">
                <ul>
                    ...
                    <li class="">
                        <a class="btn btn-menu btn-tag" title="Search" data-charlimit="10" tag="Buscar" role="tab" data-toggle="tab" href="#tabSearch" aria-expanded="false">
                            <div class="icon-wrapper"><i class="fa fa-search" aria-hidden="true"></i></div>
                        </a>
                    </li>

                    <li class="active">
                        <a class="btn btn-menu btn-tag" title="Templates" data-charlimit="10" tag="Ficha" role="tab" data-toggle="tab" href="#tabLayouts" aria-expanded="true">
                            <div class="icon-wrapper"><i class="fa fa-file-o" aria-hidden="true"></i></div>
                        </a>
                    </li>

                    <li class="">
                        <a class="btn btn-menu btn-tag" title="Images" data-charlimit="10" tag="Materiales" role="tab" data-toggle="tab" href="#tabMateriales" aria-expanded="false">
            ...
            <div class="tool-content">
                ...
                <div role="tabpanel" class="tab" id="tabSearch">
                    ...
                    <div class="search-container" style="display: block;">
                        <input type="text" name="search" id="searchPieza" placeholder="Buscar" autocomplete="off">
                        <div class="search-button" id="search-button">
                          <i class="fa fa-search-minus"></i>
                        </div>
                          <div class="wrapper"  style="top: 0px;">
                                <div class="antiscroll-wrap">
                                  <div class="antiscroll-inner" style="overflow: auto; width: 315px; height: 636px;">
                                   <?php echo $_smarty_tpl->tpl_vars['f_cat_search']->value;?>
               ...
               <div role="tabpanel" class="tab" id="tabMateriales">
                            ...
                            <div class="tab-content sub-category template accordion active">
                              <div class="wrapper" id="accordion" style="top: 0px;">
                                <dl id="dl_piezas">
                                   ...
                                   <?php echo $_smarty_tpl->tpl_vars['f_cat']->value;?>
                            ...
                            <div class="antiscroll-wrap">
                                <div class="antiscroll-inner" style="width: 315px; height: 407px;">
                                    ...
                                    <table width="100%" align="center" id="table_materials" style="margin-left: 50px;">
                                            <?php echo $_smarty_tpl->tpl_vars['listado_esquemas_tipo']->value;?>
                        ...
                        <div class="image-list" id="sidebarContainer">
                            <div class="antiscroll-wrap">
                                <div class="antiscroll-inner" style="width: 315px; height: 407px;">
                                   ...
                                   <table width="100%" align="center" id="table_materials" style="margin-left: 50px;">
                                            <?php echo $_smarty_tpl->tpl_vars['listado_esquemas']->value;?>
                ...
                <div role="tabpanel" class="tab active" id="tabLayouts">
                    <div class="header-links">
                      ...
                      <?php echo $_smarty_tpl->tpl_vars['armado']->value;?>


                      <a onclick="guardar_armado2(1,1,'x',1);" style="margin: 20px;" id="guardar_armado2" class="btn btn-primary locked">Modificar</a>
...
-->
            <ul class="tool-page">
                <li>
                    <a class="btn btn-gray prev disabled" id="prev_page" data-popover="tooltip" data-placement="top" data-original-title="Previous design"><i class="fa fa-angle-left"></i></a>
                </li>
                <li class="page-count">
                    <div class="page-count-text">
                        <span data-popover="tooltip" data-placement="top" id="current_page" data-original-title="Current design">1</span>/
                        <span data-popover="tooltip" data-placement="top" id="total_page" data-original-title="Total designs">1</span>
                    </div>
                    <input type="text" class="page-number hidden">
                </li>
                <li>
                    <a class="btn btn-gray next" id="next_page"><i class="icon-chevron-right arrow hidden" data-popover="tooltip" data-placement="top" data-original-title="Next design"></i><i class="fa fa-plus" data-popover="tooltip" data-placement="top" data-original-title="Add design"></i></a>
                </li>
            </ul>
            <!--
-->
...
-->
        ...
        <panel id="canvas-panel" >
          ...
          <?php $_smarty_tpl->_subTemplateRender("file:./contenido5.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
...
<form id="nada" method="post" action="https://electricyes.es/content/6-circuito">
    <input type="text" name="carga_id" id="carga_id" value="0">
</form>
...
<form id="addCart" method="post">
    <input type="text" name="addCart" id="addCart" value="1">
</form>
