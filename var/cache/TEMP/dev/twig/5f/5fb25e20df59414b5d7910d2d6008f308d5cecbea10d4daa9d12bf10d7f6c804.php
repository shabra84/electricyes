...
class __TwigTemplate_3edc6b42697eb8118300d0a6af3e63f7f7d605c4725cabe7856448ac08217a5c extends Twig_Template
{
...
";
    ...
    <div class=\"panel-body\" id=\"supplier_combination_";
      ...
      <div>
        ";
            // line 44
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), ($context["collectionName"] ?? $this->getContext($context, "collectionName")), array(), "array"), 'errors');
            echo "
        <table class=\"table\">
...
{% endfor %}
", "@Product/ProductPage/Forms/form_supplier_combination.html.twig", "/home/nuevaelectricyes/public_html/src/PrestaShopBundle/Resources/views/Admin/Product/ProductPage/Forms/form_supplier_combination.html.twig");
    }
}
