...
class __TwigTemplate_29c1ff1340c62a73304fb5749ffaf07cfe85f8acc22d6153ec1981b988ce1d8d extends Twig_Template
{
    ...
    <div class=\"panel panel-default\">
      <div class=\"panel-body\">
        <div>
          ";
            // line 50
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "suppliers", array()), 'errors');
            echo "
          <table class=\"table\" id=\"form_step6_suppliers\">
            ...
            foreach ($context['_seq'] as $context["key"] => $context["supplier"]) {
                ...
                <td>";
                // line 62
                echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "default_supplier", array()), $context["key"], array(), "array"), 'widget');
                echo "</td>
              </tr>
            ";
            }
...
{% endif %}
", "@Product/ProductPage/Forms/form_supplier_choice.html.twig", "/home/nuevaelectricyes/public_html/src/PrestaShopBundle/Resources/views/Admin/Product/ProductPage/Forms/form_supplier_choice.html.twig");
    }
}
