...
class __TwigTemplate_8cdbc0de8ceec5c131a9b523566b50bd546ae965f4fc6a2cd5208632258f098c extends Twig_Template
{
    ...
    <div class=\"col-lg-4\">
      <a
        href=\"";
        // line 29
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_product_unit_action", array("action" => "delete", "id" => ($context["productId"] ?? $this->getContext($context, "productId")))), "html", null, true);
        echo "\"
    ...
    <div class=\"col-sm-5 col-lg-7 text-right\">
      ";
        ...
        if (($context["is_shop_context"] ?? $this->getContext($context, "is_shop_context"))) {
          ...
          data-redirect=\"";
            // line 73
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_product_unit_action", array("action" => "duplicate", "id" => ($context["productId"] ?? $this->getContext($context, "productId")))), "html", null, true);
            echo "\"
          data-toggle=\"pstooltip\"
          title=\"";
            // line 75
...
{% endblock %}
", "@Product/ProductPage/Blocks/footer.html.twig", "/home/nuevaelectricyes/public_html/src/PrestaShopBundle/Resources/views/Admin/Product/ProductPage/Blocks/footer.html.twig");
    }
}
