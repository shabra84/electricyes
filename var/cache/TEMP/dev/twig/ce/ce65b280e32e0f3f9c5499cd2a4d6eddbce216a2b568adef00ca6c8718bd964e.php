...
class __TwigTemplate_106a1f49dd7686feb72db15b79afda3c70ebd7415921b31b6d5b0dee4696706c extends Twig_Template
{
    ...
    <div class=\"col-md-12\">
      <div class=\"container-fluid\">
        ...
        echo "
            ...
            <div id=\"product-images-container\" class=\"mb-4\">
              <div id=\"product-images-dropzone\" class=\"panel dropzone ui-sortable col-md-12\"
                  url-upload=\"";
        // line 41
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_product_image_upload", array("idProduct" => ($context["productId"] ?? $this->getContext($context, "productId")))), "html", null, true);
        echo "\"
                  url-position=\"";
        // line 42
        ...
        echo "
            ...
            ";
        // line 109
        echo $this->env->getExtension('PrestaShopBundle\Twig\HookExtension')->renderHook("displayAdminProductsMainStepLeftColumnMiddle", array("id_product" => ($context["productId"] ?? $this->getContext($context, "productId"))));
        echo "
        ...
        echo "</button>
            ...
            <div id=\"manufacturer\" class=\"mb-3\">
              ";
        // line 134
        echo twig_include($this->env, $context, "@Product/ProductPage/Forms/form_manufacturer.html.twig", array("form" => ($context["formManufacturer"] ?? $this->getContext($context, "formManufacturer"))));
        echo "
            </div>
            ...
            <div id=\"related-product\" class=\"mb-3\">
              ";
        // line 138
        echo twig_include($this->env, $context, "@Product/ProductPage/Forms/form_related_products.html.twig", array("form" => ($context["formRelatedProducts"] ?? $this->getContext($context, "formRelatedProducts"))));
        echo "
            </div>

            ";
        // line 141
        echo $this->env->getExtension('PrestaShopBundle\Twig\HookExtension')->renderHook("displayAdminProductsMainStepLeftColumnBottom", array("id_product" => ($context["productId"] ?? $this->getContext($context, "productId"))));
        echo "
        ...
        echo "</label>
                        ";
        // line 232
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Extension\HttpKernelRuntime')->renderFragment(Symfony\Bridge\Twig\Extension\HttpKernelExtension::controller("PrestaShopBundle:Admin/Product:renderField", array("productId" => ($context["productId"] ?? $this->getContext($context, "productId")), "step" => "step2", "fieldName" => "id_tax_rules_group")));
        echo "
                      </div>
                      <div class=\"col-md-12\">
                        <span class=\"small font-secondary\">
...
";
    ...
    public function block___internal_25943dde3644d8c323b6ad676eb647752b8a2dd216c9cceb8e90b72055f97312($context, array $blocks = array())
    {
        ...
        // line 118
        echo "                    ";
        echo twig_include($this->env, $context, "@Product/ProductPage/Forms/form_feature.html.twig", array("form" => $this->getAttribute($this->getAttribute(($context["formFeatures"] ?? $this->getContext($context, "formFeatures")), "vars", array()), "prototype", array())));
        echo "
                  ";
...
", "@Product/ProductPage/Panels/essentials.html.twig", "/home/nuevaelectricyes/public_html/src/PrestaShopBundle/Resources/views/Admin/Product/ProductPage/Panels/essentials.html.twig");
    }
}
