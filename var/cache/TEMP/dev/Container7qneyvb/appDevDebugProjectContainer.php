...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('V6Znpa+tMQ', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iWaVHvUYFG', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array())) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'nuevaele_prestashopdb', 'user' => 'nuevaele_admin', 'password' => '7Y5gvd8Vdtz7Ck4n', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.0999999999999996447286321199499070644378662109375, 'defaultTableOptions' => array()), $b, $c, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_ae143d8dae3de4a26997d9cdf28cf275e7aa7ff9ee51ec70e8fac2129f685bef');
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('We0xwnxDBZ', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0A2CgGJU-L', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('aii3UE+Yke', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('AiTyzaartV1y0OCNMVdZbkbc63HrzetrcSROkmr61hMyxejFrDuhOH89')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('AiTyzaartV1y0OCNMVdZbkbc63HrzetrcSROkmr61hMyxejFrDuhOH89');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.active_modules' => array(
                ...
                51 => 'welcome',
                52 => 'blockreassurance',
                53 => 'ps_categoryproducts',
                54 => 'ps_specials',
                55 => 'sampledatainstall',
                56 => 'tmcategoryproducts',
                57 => 'tmdaydeal',
                58 => 'tmheaderaccount',
                59 => 'tmmanufacturerblock',
                60 => 'tmmegamenu',
                61 => 'tmmosaicproducts',
                62 => 'tmproductcustomtab',
                63 => 'tmproductlistgallery',
                64 => 'tmproductzoomer',
                65 => 'tmsearch',
                66 => 'ps_brandlist',
                67 => 'pk_favorites',
            ...
            'database_port' => '',
            'database_name' => 'nuevaele_prestashopdb',
            'database_user' => 'nuevaele_admin',
            'database_password' => '7Y5gvd8Vdtz7Ck4n',
            'database_prefix' => 'ps_',
            ...
            'secret' => 'AiTyzaartV1y0OCNMVdZbkbc63HrzetrcSROkmr61hMyxejFrDuhOH89',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-10-28',
            'locale' => 'es-ES',
            'cookie_key' => '9qPEL15rfjqWV9FNRreix7dtmcEOTBWabI2AYNoNSV1tV8esTY87u9Fx',
            'cookie_iv' => 'JHRuJugK',
            'new_cookie_key' => 'def0000007a78daa5528df2844cbcd1f63198b6b704c0933ee79ed05aa7c106a4209183c793d6e4dc21fb9f30df3d85d6f0e41b07add690222d414dc49c0302349de0e3e',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => 'AiTyzaartV1y0OCNMVdZbkbc63HrzetrcSROkmr61hMyxejFrDuhOH89',
